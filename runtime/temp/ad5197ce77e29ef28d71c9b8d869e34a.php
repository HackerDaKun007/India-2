<?php /*a:1:{s:74:"/Volumes/dakun/www/India-2/application/lmgadmin/view/flowdate/uvindex.html";i:1586178170;}*/ ?>
...
<script>
    layui.use(['form', 'layer', 'table','laydate'], function() {
        ...
        table.on('tool(content)',function(obj) {
            let data = obj.data;
            if (obj.event == 'edit') {
                let add_url = public_url + 'uv.html';
                $.Public.yzPost({
                    type: 'post',
                    url: add_url,
                    data: '',
                    success: function () {
                        ...
                        var tableIns = table.render({
                            ...
                            , cellMinWidth: 80 //全局定义常规单元格的最小宽度，layui 2.2.1 新增
                            , cols: [[
                                {field: 'uv_id', width: 100, title: 'ID', sort: true}
                                , {field: 'ip', width: 140, title: 'ip地址'}
                                , {field: 'ipadder', width: '', title: 'ip地区'}
